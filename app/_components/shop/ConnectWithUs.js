        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground font-sans font-semibold text-base max-w-md mx-auto">
              Follow us on Instagram for game night inspo, behind-the-scenes,
          ...
          <AnimatedSection variant="fade-up" delay={200}>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 max-w-5xl mx-auto">
              {[
                { src: galleryGameNight, alt: "Game night fun" },
                { src: galleryBoxCloseup, alt: "SAMOSA box closeup" },
                { src: galleryPlaying, alt: "Playing cards" },
                { src: galleryFounder, alt: "Founder with SAMOSA" },
                { src: galleryBoardSetup, alt: "Board setup" },
                { src: galleryBoardOverhead, alt: "Board overhead" },
              ].map((item, index) => (
                <a
                  key={index}
                  href="https://www.instagram.com/playsamosa/"
                  target="_blank"
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-2xl">
          <AnimatedSection variant="fade-up">
            ...
            <p className="text-primary/70 font-sans font-semibold text-base md:text-lg mb-8">
              Stay updated with new releases, tips, and exclusive content.
            </p>
