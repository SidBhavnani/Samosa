    ...
    <div className="min-h-screen bg-primary pt-32 md:pt-40 pb-16 md:pb-24 overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="max-w-[470px] mx-4">
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          "Services"). SAMOSA is powered by Shopify, which enables us to provide
          the Services to you. This Privacy Policy describes how we collect,
          use, and disclose your personal information when you visit, use, or
          make a purchase or other transaction using the Services or otherwise
          communicate with us. If there is a conflict between our Terms of
          Service and this Privacy Policy, this Privacy Policy controls with
          respect to the collection, processing, and disclosure of your personal
          information.
          <br />
          <br />
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          cannot identify or be reasonably linked to you. We may collect or
          process the following categories of personal information, including
          ...
          <li className="ml-6 mb-2">
            ...
            and your past transactions.
          </li>
          <li className="ml-6 mb-2">
            Communications with us including the information you include in
            communications with us, for example, when sending a customer support
            inquiry.
          </li>
          <li className="ml-6 mb-2">
            Device information including information about your device, browser,
            or network connection, your IP address, and other unique
            identifiers.
          </li>
          <li className="ml-6 mb-2">
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          <li className="ml-6 mt-2">
            Directly from you including when you create an account, visit or use
            the Services, communicate with us, or otherwise provide us with your
            personal information;
          </li>
          <li className="ml-6">
            Automatically through the Services including from your device when
            you use our products or services or visit our websites, and through
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          <li className="ml-6 mb-2">
            ...
            in, to send notifications to you related to your account, to process
            ...
            to facilitate any returns and exchanges, to enable you to post
            reviews, and to create a customized shopping experience for you,
            such as recommending products related to your purchases. This may
            include using your personal information to better tailor and improve
            the Services.
          </li>
          <li className="ml-6 mb-2">
            ...
            postal mail, and to show you online advertisements for products or
            services on the Services or other websites, including based on items
            you previously have purchased or added to your cart and other
          ...
          <li className="ml-6 mb-2">
            ...
            experience, detect, investigate or take action regarding possible
            fraudulent, illegal, unsafe, or malicious activity, protect public
            safety, and to secure our services. If you choose to use the
          ...
          <li className="ml-6 mb-2">
            ...
            you with customer support, to be responsive to you, to provide
          ...
          <li className="ml-6 mb-2">
            ...
            applicable law or respond to valid legal process, including requests
            from law enforcement or government agencies, to investigate or
            participate in civil discovery, potential or actual litigation, or
            other adversarial legal proceedings, and to enforce or investigate
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          <li className="ml-6 mb-2">
            ...
            online activity with different merchants and websites. Our business
            and marketing partners will use your information in accordance with
            their own privacy notices. Depending on where you reside, you may
            have a right to direct us not to share information about you to show
            you targeted advertisements and marketing based on your online
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          as well as third parties that may be located in countries other than
          where you reside, in order to provide and improve the Services for
          you. In addition, to help protect, grow, and improve our business, we
          use certain Shopify enhanced features that incorporate data and
          information obtained from your interactions with our Store, along with
          other merchants and with Shopify. To provide these enhanced features,
          Shopify may make use of personal information collected about your
          interactions with our store, along with other merchants, and with
          Shopify. In these circumstances, Shopify is responsible for the
          processing of your personal information, including for responding to
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          <li className="ml-6 mb-2">
            ...
            any processing based on your consent before its withdrawal.
          </li>
          You may exercise any of these rights where indicated on the Services
          or by contacting us using the contact details provided below. To learn
          ...
          you can visit https://privacy.shopify.com/en.
          <br />
          <br />
          We will not discriminate against you for exercising any of these
          rights. We may need to verify your identity before we can process your
          requests, as permitted or required under applicable law. In accordance
          with applicable laws, you may designate an authorized agent to make
        ...
        <p className="uppercase font-bystander leading-relaxed text-samosa-cream mb-8">
          ...
          Area or the United Kingdom, we will rely on recognized transfer
          mechanisms like the European Commission's Standard Contractual
